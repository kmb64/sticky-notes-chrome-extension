...
//            var $this = $(this);
//
//            if (localStorage.getItem(settings.pageKey + 'notes') != null &&
// localStorage.getItem(settings.pageKey + 'notes') != 0 && settings.saveMe) {
//
//
...
//            else {
//
//                createNote($this, settings.id, settings.colour, settings.left, settings.top,
// settings.height, settings.width, settings.text);
//
//            }
//
//
...
//    var noteArray = { 'top': note.position().top, 'left': note.position().left, 'text': noteText,
// 'colour': note.attr('rel'), 'width': note.width(), 'height': note.height() };
...
//
//    var note = $('<div class="note ' + colour + '-note"  rel="' + colour + '"  id="' + id + '"><div class="' +
// colour + '-note-top">' +
